...
@Component
public class GroupPriceFeed implements Processing {
    ...
    public GroupPriceFeed(FtpTransporterImpl ftp, ExcelParser excelParser, XmlTransporterImpl xmlTransporter,
                          @Qualifier(value = "xmlCreatorGroupPrice") XmlCreator xmlFinalCreator,
    ...
    public List<String> start() {
        ...
        if (isExcelPropertiesParsed) {
            ...
            for (Offer offer : offersFromInsalesFeed) {
